    ...
    filterTemplate: {
        input (that, field, isVisible, placeholder, value) {
            return Utils.sprintf(
                '<input type="text" class="form-control bootstrap-table-filter-control-%s" style="height:20px; font-size:10pt; width: 100%; visibility: %s" placeholder="%s" value="%s">',
                field,
                isVisible,
        ...
        select ({ options }, field, isVisible) {
            return Utils.sprintf(
                '<select class="form-control bootstrap-table-filter-control-%s" style="height:20px; font-size:10pt; width: 100%; visibility: %s" dir="%s"></select>',
                field,
                isVisible,
